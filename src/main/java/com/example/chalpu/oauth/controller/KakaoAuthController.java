...
import com.example.chalpu.oauth.dto.KakaoLoginRequest;
...
import com.example.chalpu.oauth.security.oauth2.user.KakaoOAuth2UserInfo;
...
public class KakaoAuthController {
    ...
    @Operation(
            ...
            description = """
                    ...
                    **iOS (Swift) 요청 예시:**
                    ```swift
                    guard let url = URL(string: "chalpu.com/api/auth/kakao/login") else { return }
